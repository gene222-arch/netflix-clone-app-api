...
Route::middleware(['api', 'verified'])->group(function () 
{
    ...
    Route::prefix('casts')->group(function () 
    {
        ...
        Route::put('/restore', [CastsController::class, 'restore']);
    ...
    Route::prefix('coming-soon-movies')->group(function () 
    {
        ...
        Route::put('/restore', [ComingSoonMoviesController::class, 'restore']);
        Route::put('/{comingSoonMovie}', [ComingSoonMoviesController::class, 'update']);
        Route::put('/{comingSoonMovie}/release', [ComingSoonMoviesController::class, 'releaseMovie']);
    ...
    ], function () 
    {
        ...
        Route::put('/restore', [EmployeesController::class, 'restore']);
    ...
    /**
      ...
      */
        ...
        ], function () 
        {
            ...
            Route::put('/payment-authorizations/mark-all-as-read', [NotificationsController::class, 'markAllPaymentAuthNotifsAsRead']);
            Route::put('/payment-authorizations/mark-as-read/{notification}', [NotificationsController::class, 'markPaymentAuthNotifsAsRead']);
            Route::delete('/payment-authorizations/clear', [NotificationsController::class, 'clearPaymentAuthNotifs']);
        });
    ...
    Route::prefix('user-profiles')->group(function () 
    {
        ...
        Route::put('/disable', [UserProfilesController::class, 'disable']);
